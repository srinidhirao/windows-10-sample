...
var webDb = /** @class */ (function () {
    ...
    webDb.reloadAppMeta = function () {
        ...
        if (appMeta) {
            ...
            if (!loginParameters.appName || !loginParameters.url) {
                console.log('App name or App Url not provided. Current session token will be ignored and forced user to login')
                return false;
            }
            restUtil.appMeta = {};
            restUtil.appMeta.frontEnd = loginParameters.feUserId;
